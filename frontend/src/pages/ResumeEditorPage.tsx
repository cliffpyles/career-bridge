...
export function ResumeEditorPage() {
  ...
  // ── AI-generated notice state ───────────────────────────────────────────────
  const [showAIBanner, setShowAIBanner] = useState(
    !!(location.state as { aiGenerated?: boolean } | null)?.aiGenerated,
  )
  ...
  return (
    <div className={styles.page}>
      ...
      {/* ── AI-generated notice ───────────────────────────────────────────── */}
      {showAIBanner && (
        <div className={styles.aiBanner} role="status" aria-live="polite">
          <span className={styles.aiBannerSparkle} aria-hidden="true">✦</span>
          <span className={styles.aiBannerText}>
            This resume was generated by AI from your experience library and the job
            description you provided. All content is editable — review, refine, and
